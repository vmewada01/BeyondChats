...
const DUMMY_CHUNKS = [
  "Our company was founded in 2010 with a mission to revolutionize customer service.",
  "We offer 24/7 support through our AI-powered chatbot system.",
  "Our team consists of experts in machine learning and customer experience.",
];
    ...
    >
      <div className="text-center">
        ...
        <p className="mt-2 text-gray-600">
          We're analyzing your website content to train your chatbot
        </p>
      </div>
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <div className="rounded-lg border border-gray-200 p-6">
          <h3 className="mb-4 text-lg font-semibold">
            {selectedPage ? `Content from ${selectedPage}` : 'Select a page to view content'}
          </h3>
          {selectedPage ? (
            <div className="space-y-3">
